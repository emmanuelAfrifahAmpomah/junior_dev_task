    ...
    <div id="selectProduct" class="mb-5">
      ...
      <fieldset class="was-validated" id="furniture">
        ...
        <div class="row mb-3">
          ...
          <div class="col-sm-auto">
          <input id="height" type="number" min="1" step="1" class="form-control" 
          name="height" value="<?= $height?>" required>
        ...
        <div class="row mb-3">
          ...
          <div class="col-sm-auto">
          <input id="width" type="number" min="1" step="1" class="form-control" 
          name="width" value="<?= $width?>" required>
        ...
        <!-- Input for length -->
          ...
          <div class="col-sm-auto">
          <input id="length" type="number" min="1" step="1" class="form-control" 
      ...
      <fieldset class="was-validated" id="book">
        <div class="row mb-3">
          ...
          <div class="col-sm-auto">
          <input id="weight" type="number" min="1" step="1" class="form-control" 
          name="weight" value="<?= $weigt?>" required>
